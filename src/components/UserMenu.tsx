    ...
    <div className="relative" ref={menuRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 mt-3 w-64 bg-white/90 backdrop-blur-xl rounded-2xl shadow-xl border border-white flex-col overflow-hidden z-50">
          ...
          <a href="https://mathgenius.vanpower.live" target="_blank" rel="noreferrer" className="px-4 py-4 hover:bg-slate-50 flex items-center gap-3 text-slate-700 font-bold border-b border-slate-100 group">
          ...
          <a href="https://wordsmith.vanpower.live" target="_blank" rel="noreferrer" className="px-4 py-4 hover:bg-slate-50 flex items-center gap-3 text-slate-700 font-bold border-b border-slate-100 group">
