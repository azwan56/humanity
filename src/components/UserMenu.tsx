  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      >
        ...
        <svg className="w-4 h-4 text-white pr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="absolute right-0 mt-3 w-64 bg-white/90 backdrop-blur-xl rounded-2xl shadow-xl border border-white flex-col overflow-hidden z-50">
          ...
          */}
          ...
          <button
            ...
            className="px-4 py-3 bg-white hover:bg-slate-50 text-slate-600 font-bold w-full flex justify-center items-center gap-2 transition-colors"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
